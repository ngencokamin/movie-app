...
Movie.create!([
  {title: "Memento", year: 2000, plot: "I don't know. You probably don't either.", director: nil, english: nil},
  {title: "Howl's Moving Castle", year: 2004, plot: "When an unconfident young woman is cursed with an old body by a spiteful witch, her only chance of breaking the spell lies with a self-indulgent yet insecure young wizard and his companions in his legged, walking castle.", director: nil, english: nil},
  {title: "Monty Python and the Holy Grail", year: 1975, plot: "King Arthur and his Knights of the Round Table embark on a surreal, low-budget search for the Holy Grail, encountering many, very silly obstacles.", director: nil, english: nil},
